...
import { Actors, ImageType, StoriesCategories, Story } from "../types/models";
...
export const stories: Story[] = [
  ...
  },
  {
    ...
    content: "Once upon a time, in a cozy little town, there lived a curious and imaginative young girl named Lily. Lily loved exploring and discovering new things, especially in her grandfather's old and dusty attic. One sunny afternoon, while rummaging through the attic, Lily stumbled upon a mysterious box tucked away in a corner.\n\nAs she opened the box, a dazzling light illuminated the room, and to Lily's amazement, she found a magical toolbox inside. The toolbox was filled with an array of extraordinary tools that seemed to have a mind of their own. There was a paintbrush that could bring drawings to life, a wrench that could fix anything, and even a tiny hammer that could build the most intricate structures.\n\nOverwhelmed with excitement, Lily knew that she had stumbled upon something truly extraordinary. With her newfound treasure, she embarked on a journey of invention and creativity. She couldn't wait to see what wonders she could create using the magical tools.\n\nLily's first invention was a pair of enchanted shoes that could make her fly. With the help of the toolbox, she attached wings to her shoes, and in an instant, she was soaring high above the treetops, giggling with delight. She flew across the town, spreading joy to everyone she passed. Children cheered and adults marveled at the little inventor and her magical creation.\n\nInspired by her success, Lily continued inventing amazing things. She created a talking teddy bear that kept her company during lonely nights, a water-powered machine that made rainbows on sunny days, and a bubble-blowing contraption that filled the air with shimmering bubbles of all colors.\n\nWord of Lily's inventions quickly spread, and soon, the entire town was buzzing with excitement. Parents and children alike flocked to Lily's workshop, eager to see what new creations she would come up with next. Lily's inventions not only brought joy and wonder to the townsfolk but also solved everyday problems and made life a little easier.\n\nAs the little inventor's fame grew, so did her confidence. She realized that her magical toolbox was not just a source of endless possibilities but also a way to bring happiness to others. Lily decided to share her magical toolbox with her friends, teaching them the joy of inventing and unleashing their creativity.\n\nTogether, Lily and her friends formed a club of young inventors, exploring the limitless potential of their imaginations. They built fantastical machines, painted incredible works of art, and dreamed up worlds beyond their wildest dreams.\n\nAnd so, in that cozy little town, the legacy of the little inventor named Lily lived on. Her magical toolbox became a symbol of inspiration and possibility, reminding everyone that with a curious mind and a little bit of imagination, they too could create wonders.\n\nThe end."
  },
  {
    id: "58",
    title: "The Magical Forest",
